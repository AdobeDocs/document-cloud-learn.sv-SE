...
<tr>
  ...
  <td>
    <a href="lob/legal/legal-overview.md">
      <img alt="Juridiska användningsfall" src="../assets/use-case-legal.png" />
    </a>
    <div>
    <a href="lob/legal/legal-overview.md"><strong>Juridiska användningsfall</strong></a>
    </div>
    <em>Lär dig hur juridiska team snabbt kan förstå komplexa dokument och hantera kritiska risker och förändringar</em>
    <br>
  </td>
  <td>
    <a href="lob/sales/sales-overview.md">
      <img alt="Försäljningsanvändningsfall" src="../assets/use-case-sales.png" />
    </a>
    <div>
    <a href="lob/sales/sales-overview.md"><strong>Försäljningsanvändningsfall</strong></a>
    </div>
    <em>Lär säljteamen gå från insikt till påverkan genom smartare samarbete och snabbare skapande av innehåll</em>
    <br>
  </td>
</tr>
</table>
