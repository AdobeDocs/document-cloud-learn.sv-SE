...
Hämta [Adobe Acrobat Reader-mobilappen](https://www.adobe.com/acrobat/mobile/acrobat-reader.html){target="_blank"}, som är den kostnadsfria globala standarden för att visa, kommentera och signera PDF.
...
Hämta [Adobe Scan-mobilappen](https://www.adobe.com/acrobat/mobile/scanner-app.html){target="_blank"} för att registrera alla pappersdokument och omvandla dem till högkvalitativa PDF-filer med sökbar text.
...
Hämta [Adobe Fill &amp; Sign-mobilappen](https://www.adobe.com/acrobat/mobile/fill-sign-pdfs.html){target="_blank"} för att fylla i, signera och skicka formulär var som helst, på vilken enhet som helst, enbart med fingret eller en penna.
