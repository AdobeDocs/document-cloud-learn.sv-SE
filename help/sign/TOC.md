...
+ Komma igång {#getting-started}
   ...
   + Skicka {#getting-started-sending}
      ...
      + [Skicka ett dokument till en enda signatör](sign-beginner-tutorials/send-to-single-recipient.md)
      + [Skicka till flera signatörer](sign-beginner-tutorials/send-to-multiple-recipients.md)
...
+ Avancerade uppgifter {#advanced-tasks}
   ...
   + Skicka {#advanced-tasks-sending}
      ...
      + [Skapa ett anpassat arbetsflöde](https://experienceleague.adobe.com/sv/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
...
+ Mobilt {#mobile}
   ...
   + Mobila självstudiekurser {#mobile-tutorials}
      ...
      + [Mobilanpassad vy](mobile/mobile-friendly.md)
      + [Skapa mobilanpassad vy](mobile/create-mobile-friendly.md)
